  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleContactSubmit} style={{   width: "100%",
        ...
        <Flex fillWidth maxWidth={24} direction="column" gap="12">
          <Input 
            id="contact-name" 
          ...
          <Textarea 
            id="contact-message" 
            placeholder="Brief message or scope" 
            value={message} 
            onChange={(e) => setMessage((e.target as HTMLTextAreaElement).value)} 
          />

          <Flex wrap gap="12" fillWidth paddingTop="4" horizontal="center">
          ...
          <Input 
            ...
            placeholder="Availability (timezone/hours)" 
            value={availability} 
